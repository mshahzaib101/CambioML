...
export const metadata: Metadata = {
  title: "Blog | CambioML",
  description:
    "CambioML is a platform that provides a wide range of AI tools and services to help you stay on top of your business. Generate images, text and everything else that you need to get your business off the ground.",
  openGraph: {
