  ...
  return (
    ...
    >
      <Container className="flex  flex-col items-center justify-center">
        ...
        >
          Transform Your AI Experience with CambioML
        </Heading>
        <Subheading className="text-center mt-2 md:mt-6 text-base md:text-xl text-muted dark:text-muted-dark max-w-3xl mx-auto relative z-10">
          Seamlessly Integrate Multiple AI Models, Build Powerful Applications,
          and Enhance Developer Productivity with Our Advanced AI Platform
        </Subheading>
        <FeaturedImages
